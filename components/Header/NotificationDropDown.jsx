    ...
    <div className='absolute top-14 bg-white right-5 w-[350px] max-h-[700px] shadow-lg rounded-lg p-4 overflow-hidden overflow-y-scroll'>
        ...
        <div className='flex items-center space-x-4'>
          <div className='rounded-[50%] cursor-pointer'>
            <span className='hover:bg-[#E3E5E8] rounded-2xl py-2 px-3 font-semibold text-slate-600'>All</span>
          </div>
          <div className='rounded-[50%] cursor-pointer'>
            <span className='hover:bg-[#E3E5E8] rounded-2xl py-2 px-3 font-semibold text-slate-600'>Unread</span>
          </div>      
        </div>
        </div>
    </div>
