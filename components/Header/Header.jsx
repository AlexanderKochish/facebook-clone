...
const Header = ({
  ...
  return (
    <header
      ref={ref}
      className="bg-white dark:bg-[#242526] h-14 shadow-md px-3 flex justify-between fixed top-0 left-0 right-0 items-center z-30"
    >
      <div className="flex items-center space-x-2">
        ...
        <div className="bg-gray-100 text-md dark:bg-[#323335] flex items-center px-2 text-slate-500 dark:text-slate-100 w-full rounded-3xl">
          ...
          <input
            ...
            className="bg-inherit outline-none py-2 px-3"
          />
        </div>
      </div>
      <ul className="flex items-center space-x-2 mr-14">
        <Link href={"/"}>
          <li
            className={
              pathname === "/"
                ? "flex justify-center items-center pb-2 -mb-2 text-sky-600 w-24 h-12 cursor-pointer border-b-4 border-sky-600"
                : "flex justify-center items-center rounded-lg w-24 h-12 text-gray-500 dark:text-slate-100 hover:bg-gray-100 dark:hover:bg-[#3A3B3C]"
            }
          >
        ...
        <Link href={"/watch"}>
          <li
            className={
              pathname === "/watch"
                ? "flex justify-center items-center pb-2 -mb-2 text-sky-600 w-24 h-12 cursor-pointer border-b-4 border-sky-600"
                : "flex justify-center items-center rounded-lg w-24 h-12 text-gray-500 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-[#3A3B3C]"
            }
          >
      ...
      <ul className="flex space-x-2 items-center">
        ...
        <li onClick={handleMessenger}>
          <div
            className={
              messenger
                ? "p-2 bg-sky-100 rounded-[50%] cursor-pointer hover:bg-sky-200 text-sky-700"
          ...
          >
            ...
            <span className='bg-red-600 absolute rounded-[50%] w-4 h-4 -top-2 -right-2 flex items-center justify-center p-1'>1</span>
            </div>
