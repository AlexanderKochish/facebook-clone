            ...
            <div className='h-full w-full flex-auto flex-col'>
                <ul className='flex flex-col justify-between overflow-hidden overflow-y-scroll p-2 self-start'>
                    ...
                    {messages?.map((message)=>(
                        <li key={message.id} className={currentUser?.uid === message.senderId?'self-end mb-2':'self-start mb-2'}>
                            {message?.text?<div className={currentUser?.uid === message.senderId?'flex items-center p-1 rounded-2xl bg-sky-500 text-white self-end'
                            ...
                            {message?.image? 
                                <div className='flex flex-col bg-gray-100 drop-shadow-md rounded-md p-1'>
                                    <div className='relative w-44 h-60 mb-1'>
                                        <Image src={message?.image} fill alt='message img' className='object-cover'/>
                                    </div>
