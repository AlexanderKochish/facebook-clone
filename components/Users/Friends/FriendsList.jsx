...
const FriendsList = () => {
  ...
  return (
    <div className="w-1/4 min-h-screen flex flex-col pt-16 px-4 bg-white dark:bg-[#242526] shadow-md">
      <div className="border-b mb-5 border-gray-400 min-h-[120px] w-full flex flex-col">
        <div className="flex space-x-2 items-center">
          <div>
            <Link href={"/friends"}>
              <div className="p-2 hover:bg-gray-200 dark:hover:bg-[#323335] rounded-[50%]">
